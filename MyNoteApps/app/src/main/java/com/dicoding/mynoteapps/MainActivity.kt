        ...
        if (result.data != null) {
            ...
            when (result.resultCode) {
                NoteAddUpdateActivity.RESULT_ADD -> {
                    ...
                    showSnackbarMessage("One note has been added")
                }
                ...
                NoteAddUpdateActivity.RESULT_UPDATE -> {
                    ...
                    showSnackbarMessage("One note has been updated")
                }
                ...
                NoteAddUpdateActivity.RESULT_DELETE -> {
                    ...
                    showSnackbarMessage("One note has been deleted")
                }
            }
        }
    }
    ...
    private fun loadNotesAsync() {
        lifecycleScope.launch {
            ...
            if (notes.size > 0) {
                ...
                showSnackbarMessage("There are no notes available")
            }
